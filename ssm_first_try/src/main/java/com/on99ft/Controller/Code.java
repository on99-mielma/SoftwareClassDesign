...
public class Code {
    ...
    public static final Integer GET_ERR = 30030;
    public static final Integer UPDATE_ERR = 40040;

    public static final Integer NUMBER_ERR = 80081;
    public static final Integer METHOD_ERR = 80082;
    public static final Integer SQL_YJ_ERR = 80083;
